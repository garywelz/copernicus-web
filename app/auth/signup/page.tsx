      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Access AI-generated research podcasts
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-blue-300 rounded-lg shadow-sm bg-blue-50 text-blue-700 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-sm font-medium text-gray-900 mb-2">Test Account Preview:</h3>
          <div className="text-sm text-gray-600 space-y-1">
            <p><strong>Email:</strong> gwelz@jjay.cuny.edu</p>
            <p><strong>Tier:</strong> Free (10 podcasts/month)</p>

...
https://doi.org/10.5281/zenodo.18463304

Welz, G. (2026b). *The Programming Framework: A Universal Method for Process Analysis*. Preprint. Zenodo.  
https://doi.org/10.5281/zenodo.18463442

**Supporting prototypes and resources:**
...
https://huggingface.co/spaces/garywelz/metadata_database
...
Ahn, D. (2006). The stages of event extraction. *Proceedings of the Workshop on Annotating and Reasoning about Time and Events*, 1-8.White, J., et al. (2023). A prompt pattern catalog to enhance prompt engineering with ChatGPT. *arXiv preprint arXiv:2302.11382*.**Note on Publications:** Two preprints (Welz, 2026a) frame this work: the Knowledge Engine vision and the Programming Framework. The proposed research will generate additional peer-reviewed publications as project deliverables. The existing operational prototypes (cited above) and these preprints serve as the primary evidence of prior work and technical feasibility.
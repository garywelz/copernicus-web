...
class EpisodeService:
    ...
    def _prepare_episode_document(
        ...
        episode_doc: Dict[str, Any] = {
            ...
            "visible_on_web": bool(result_data.get("visible_on_web") or submitted_to_rss),
            "animation_player_url": result_data.get("animation_player_url"),
            "creator_attribution": creator_attribution,
            "visibility": "public" if (submitted_to_rss or result_data.get("visible_on_web")) else "private",

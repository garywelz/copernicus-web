#!/usr/bin/env python3
"""
Create Chemistry Database Table HTML

Creates an interactive database table HTML file for chemistry processes,
modeled on the GLMP/mathematics database table structure.
"""
...
def create_database_table_html(metadata_file: Path, output_file: Path):
    """Create database table HTML file"""
...
<body>
    ...
    <script>
        ...
        function populateData(data) {
            ...
            processList.forEach(process => {
                ...
                const viewerUrl = `./processes/${process.subcategory}/${process.id}.html`;
                row.innerHTML = `
    ...
    print(f"✓ Created database table HTML: {output_file}")


if __name__ == "__main__":
    script_dir = Path(__file__).parent
    project_root = script_dir.parent
    metadata_file = project_root / "chemistry-processes-database" / "metadata.json"
    output_file = project_root / "chemistry-processes-database" / "chemistry-database-table.html"
    
    create_database_table_html(metadata_file, output_file)

#!/usr/bin/env python3
"""
Extract Mathematics Flowcharts from HTML to JSON Format
"""
...
# Math subcategory mapping
SUBCATEGORY_MAP = {
    "mathematics_batch_01": "number_theory",
    "mathematics_batch_02": "calculus_analysis",
    "mathematics_batch_03": "abstract_algebra",
    "mathematics_batch_04": "linear_algebra",
    "mathematics_batch_05": "discrete_mathematics",
    "mathematics_batch_06": "geometry_topology",
    "mathematics_batch_07": "statistics_probability"
}
...
def create_json_and_metadata(input_dir: str, output_dir: str):
    ...
    batch_files = sorted([f for f in os.listdir(input_dir) if f.startswith('mathematics_batch_') and f.endswith('.html')])
    print(f"Found {len(batch_files)} mathematics batch files")
    ...
    for batch_file in batch_files:
        ...
        for i, process_data in enumerate(batch_processes):
            ...
            json_data = {
                ...
                "verified": False,
                "notes": f"Converted from mathematics batch HTML. Process number: {process_data['number']}."
            }
    ...
    metadata_json = {
        ...
        "category": "mathematics",
        "colorScheme": "5-color",
        "description": "Mathematics processes visualized using the Programming Framework with 5-color scheme. Converted from HTML batch files.",
...
if __name__ == "__main__":
    ...
    output_json_dir = "/home/gdubs/copernicus-web-public/huggingface-space/mathematics-processes-database"
    
    print("============================================================")
    print("Mathematics HTML to JSON Converter")
    print("============================================================")
